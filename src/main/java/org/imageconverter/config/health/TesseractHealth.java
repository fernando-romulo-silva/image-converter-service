...
public class TesseractHealth implements ApplicationContextAware {
    ...
    @ReadOperation
    public TesseractInfo health() {

	final var details = new LinkedHashMap<String, Object>();

	if (check(applicationContext.getBean(Tesseract.class))) {
	...
	TesseractInfo tesseractInfo = new TesseractInfo();
	tesseractInfo.setTesseractDetails(details);
...
//    }
    ...
    public static class TesseractInfo {
